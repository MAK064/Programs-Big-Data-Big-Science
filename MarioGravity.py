...
def Game():
    ...
    jmss.clear(0,0,0,1)
    if (M1y >= 0) :                                         #Checks if Mario1 is at y = 0
        jmss.drawImage("mario.png" , x = M1x , y = M1y)
    else:                                                   #Makes sure Mario1 doesn't disapear when he reaches y = 0
        jmss.drawImage("mario.png" , x = M1x , y = 0)
    if (M2y >= 0) :                                         #Checks if Mario2 is at y = 0
        jmss.drawImage('mario.png' , x = M2x , y = M2y)
    else:                                                   #Makes sure Mario2 doesn't disapear when he reaches y = 0
